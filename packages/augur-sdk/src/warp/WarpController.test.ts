  ...
  **/
  describe('empty database', () => {
    ...
    describe('top-level directory', async () => {
      ...
      test('should have an index file', async () => {});

      test('should have a checkpoint directory', async () => {});

      test('should have a tables directory', async () => {});
    });
    ...
    test('', async () => {
      ...
      await expect(ipfs.ls(`${fileHash}/tableOne`)).resolves.toEqual([
        expect.objectContaining({
          name: 'index',
          type: 'file',
        }),
      ...
      await expect(ipfs.ls(`${fileHash}/tableTwo`)).resolves.toEqual([
        expect.objectContaining({
          name: 'index',
          type: 'file',
        }),
